...
public:
    ...
    void setupUi(QDialog *rtu_changecheck)
    {
        ...
        cb_cctype->setGeometry(QRect(130, 14, 181, 31));
        cb_cctype->setMaxVisibleItems(5);
        ...
        cb_cctype_2->setGeometry(QRect(490, 14, 191, 31));
        cb_cctype_2->setMaxVisibleItems(5);
        ...
        tableWidget->setItem(1, 8, __qtablewidgetitem23);
        ...
        tableWidget->setItem(2, 8, __qtablewidgetitem32);
        ...
        tableWidget->setItem(3, 7, __qtablewidgetitem40);
        QTableWidgetItem *__qtablewidgetitem41 = new QTableWidgetItem();
        __qtablewidgetitem41->setTextAlignment(Qt::AlignCenter);
        tableWidget->setItem(3, 8, __qtablewidgetitem41);
        ...
        pushButton->setGeometry(QRect(300, 410, 89, 30));
        pushButton_2 = new QPushButton(rtu_changecheck);
        pushButton_2->setObjectName(QString::fromUtf8("pushButton_2"));
        pushButton_2->setGeometry(QRect(430, 410, 89, 30));
        pushButton_3 = new QPushButton(rtu_changecheck);
        pushButton_3->setObjectName(QString::fromUtf8("pushButton_3"));
        pushButton_3->setGeometry(QRect(560, 410, 89, 30));
        ...
        cb_device->setMaxVisibleItems(5);
        ...
        cb_harmonic->setMaxVisibleItems(5);
        ...
        cb_deviced->setMaxVisibleItems(5);
        ...
        cb_haphase->setMaxVisibleItems(5);
        ...
        cb_number->setMaxVisibleItems(5);
        ...
        cb_automan->setMaxVisibleItems(5);
        ...
        cb_linetype->setMaxVisibleItems(5);
